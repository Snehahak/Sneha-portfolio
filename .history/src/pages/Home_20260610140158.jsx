...
import {
  ...
  Layers, FlaskConical, RefreshCw, ArrowUpRight, X, ExternalLink
} from 'lucide-react'
...
// ── FIGMA EMBED HELPER ────────────────────────────────────────
// To show your Figma design:
// 1. Open your Figma file
// 2. Click Share → Copy link
// 3. Replace YOUR_FIGMA_FILE_KEY below with the key from the URL
//    e.g. https://www.figma.com/file/ABCDEF123/My-Design → key is ABCDEF123
const FIGMA_EMBED = (key) =>
  `https://www.figma.com/embed?embed_host=share&url=https://www.figma.com/file/${key}`
          ...
          <div className="work-list">
            ...
            <div className="work-item reverse">
              ...
              <div className="work-info">
                ...
                <h3>Clarkie</h3>
                <p>An AI-powered chatbot for Clark University — helping students navigate campus life, find resources, and get answers instantly through natural conversation.</p>
            ...
            {/* Figma Project 1 — replace YOUR_FIGMA_KEY_1 with your actual key */}
            <div className="work-item">
              <div className="work-img" style={{ background: 'linear-gradient(135deg, #f0f4ff 0%, #dde6ff 100%)', flexDirection: 'column', gap: 12 }}>
                <div style={{ textAlign: 'center', color: '#5b73d4', fontFamily: 'var(--serif)', fontSize: '1.1rem', fontStyle: 'italic' }}>Figma Design</div>
                {/* Once you have your Figma key, replace the div above with:
                <iframe
                  style={{width:'100%',height:'100%',border:'none'}}
                  src={FIGMA_EMBED('YOUR_FIGMA_KEY_1')}
                  allowFullScreen
                /> */}
              </div>
              <div className="work-info">
                <span className="work-tag" style={{ background: '#eef1ff', color: '#5b73d4' }}>UX Design</span>
                <h3>Figma Project — Add Your Title</h3>
                <p>Add your project description here. Describe the problem you solved, your design process, and the outcome.</p>
                <a href="https://figma.com" target="_blank" rel="noreferrer" className="work-link">
                  View in Figma <ExternalLink size={16} />
                </a>
              </div>
            </div>
            ...
            {/* Figma Project 2 */}
            <div className="work-item reverse">
              <div className="work-img" style={{ background: 'linear-gradient(135deg, #fff0f6 0%, #ffdded 100%)', flexDirection: 'column', gap: 12 }}>
                <div style={{ textAlign: 'center', color: '#c4567a', fontFamily: 'var(--serif)', fontSize: '1.1rem', fontStyle: 'italic' }}>Figma Design</div>
              </div>
              <div className="work-info">
                <span className="work-tag" style={{ background: '#fff0f6', color: '#c4567a' }}>UX Research</span>
                <h3>Figma Project — Add Your Title</h3>
                <p>Add your project description here. Describe the problem you solved, your design process, and the outcome.</p>
                <a href="https://figma.com" target="_blank" rel="noreferrer" className="work-link">
                  View in Figma <ExternalLink size={16} />
      ...
      <section id="skills">
        ...
        <div className="resume-card">
          ...
          {/* 
            ...
            3. The button below will work automatically!
          */}
        ...
        <div className="inner">
          ...
          <div className="contact-grid">
            <div className="contact-info">
              ...
              <a href="mailto:YOUR_EMAIL@clarku.edu" className="contact-link-card">
                <div className="contact-link-icon"><Mail size={20} /></div>
                <div className="contact-link-text">
                  <div className="label">Email</div>
                  <div className="value">YOUR_EMAIL@clarku.edu</div>
                </div>
                <ArrowUpRight size={16} style={{ marginLeft: 'auto', color: 'var(--text-light)' }} />
              </a>

              {/* UPDATE YOUR LINKEDIN BELOW */}
              <a href="https://linkedin.com/in/YOUR_LINKEDIN" target="_blank" rel="noreferrer" className="contact-link-card">
                ...
                <div className="contact-link-text">
                  ...
                  <div className="value">linkedin.com/in/YOUR_LINKEDIN</div>
                </div>
                <ArrowUpRight size={16} style={{ marginLeft: 'auto', color: 'var(--text-light)' }} />
              </a>
            </div>
