...
function downloadResume() {
  fetch('/Resume.pdf')
    ...
    .then(blob => {
      ...
      link.href = url
      link.download = 'Sneha_Khatiwada_Resume.pdf'
        ...
        <div className="about-grid">
          ...
          <div className="about-text">
            ...
            <div className="about-stats">
              ...
              <div className="stat-item"><div className="num">6</div><div className="label">Projects</div></div>
            ...
            <div className="contact-info">
              ...
              <a href="https://www.linkedin.com/in/snehaha-k//" target="_blank" rel="noreferrer" className="contact-link-card">
                ...
                <div className="contact-link-text">
                  ...
                  <div className="value">lhttps://www.linkedin.com/in/snehaha-k/</div>
                </div>
                <ArrowUpRight size={16} style={{ marginLeft: 'auto', color: 'var(--text-light)' }} />
              </a>
            </div>
