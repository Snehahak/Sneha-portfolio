  ...
  return (
    <>
      ...
      <section className="hero" style={{ paddingLeft: 60, paddingRight: 60 }}>
        <p className="hero-eyebrow">UI Designer | UX Researcher • Masters in Computer Science</p>
        <h1>
          Sneha<br />
      ...
      <section id="about" style={{ paddingTop: 80 }}>
        <div className="about-grid">
          ...
          <div className="about-text">
            <h2>About Me</h2>
            <p>
            I am a UX Designer and UX Researcher with a Master of Science in Computer Science from Clark University. 
            My passion lies in creating intuitive, accessible, and meaningful digital experiences that bridge user needs with business goals.
            </p>
            <p>
            With a foundation in technology and a strong interest in human-centered design, I combine user research, interaction design, and visual storytelling to develop products that are both functional and engaging. 
            I enjoy uncovering user insights, translating complex problems into simple solutions, and designing experiences that make everyday tasks easier and more enjoyable.
            </p>
            <p>
            My work is driven by empathy, curiosity, and a commitment to improving how people interact with technology. 
            I am particularly interested in UX research, product design, service design, and designing systems that support informed decision-making and positive user experiences.
            </p>
            <p>
            Beyond design, I express my creativity through ink art, mandala illustration, and watercolor painting, which continually inspire my approach to visual thinking, attention to detail, and creative problem-solving.
            </p>
