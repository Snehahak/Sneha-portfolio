...
const MIRO_EMBED_URL = 'YOUR_MIRO_EMBED_URL_HERE'
const MIRO_BOARD_URL = 'YOUR_MIRO_BOARD_URL_HERE'

export default function CaseStudyMiro() {
  const hasEmbed = MIRO_EMBED_URL !== 'YOUR_MIRO_EMBED_URL_HERE'
  const hasLink  = MIRO_BOARD_URL !== 'YOUR_MIRO_BOARD_URL_HERE'
