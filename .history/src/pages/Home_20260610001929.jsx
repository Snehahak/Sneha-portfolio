...
import {
  ...
  Layers, FlaskConical, RefreshCw, ArrowUpRight, Linkedin, X
} from 'lucide-react'
        ...
        <div className="inner">
          ...
          <div className="contact-grid">
            <div className="contact-info">
              ...
              <a href="mailto:sneha.pandey@clarku.edu" className="contact-link-card">
                <div className="contact-link-icon"><Mail size={20} /></div>
                <div className="contact-link-text">
                  <div className="label">Email</div>
                  <div className="value">sneha.pandey@clarku.edu</div>
                </div>
                <ArrowUpRight size={16} style={{ marginLeft: 'auto', color: 'var(--text-light)' }} />
              </a>
              <a href="https://linkedin.com/in/snehakpandey" target="_blank" rel="noreferrer" className="contact-link-card">
                <div className="contact-link-icon"><Linkedin size={20} /></div>
                <div className="contact-link-text">
                  <div className="label">Linkedin</div>
                  <div className="value">linkedin.com/in/snehakpandey</div>
                </div>
                <ArrowUpRight size={16} style={{ marginLeft: 'auto', color: 'var(--text-light)' }} />
              </a>
            </div>
