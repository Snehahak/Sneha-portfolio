...
// These just check that you've pasted SOMETHING that looks like a real Miro URL.
// You don't need to touch this part — only the two lines above.
const hasEmbed = MIRO_EMBED_URL.startsWith('http')
const hasLink = MIRO_BOARD_URL.startsWith('http')
